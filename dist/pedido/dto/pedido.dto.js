...
], PedidoDTO.prototype, "id_pedido", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'El campo es requerido' }),
    (0, class_validator_1.IsDateString)({}, { message: 'Formato de fecha inválido' }),
    __metadata("design:type", String)
], PedidoDTO.prototype, "fecha", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'El campo es requerido' }),
    (0, class_validator_1.IsNumber)({}, { message: 'Se necesita un número' }),
    __metadata("design:type", Number)
], PedidoDTO.prototype, "total", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'El campo es requerido' }),
    (0, class_validator_1.IsNumber)({}, { message: 'Se necesita un número' }),
    __metadata("design:type", Number)
], PedidoDTO.prototype, "estado", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'El campo es requerido' }),
    (0, class_validator_1.IsString)({ message: 'Se necesita un texto' }),
    __metadata("design:type", String)
], PedidoDTO.prototype, "metodo_pago", void 0);
